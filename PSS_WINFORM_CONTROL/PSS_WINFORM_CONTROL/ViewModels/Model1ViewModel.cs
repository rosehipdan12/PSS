    ...
    public partial class Model1ViewModel : DocumentsViewModel<Model1ModuleDescription, IModel1UnitOfWork> {
        ...
        protected override Model1ModuleDescription[] CreateModules() {
			return new Model1ModuleDescription[] {
                ...
                new Model1ModuleDescription( "order user", "order_userCollectionView", TablesGroup, GetPeekCollectionViewModelFactory(x => x.order_user)),
                ...
                new Model1ModuleDescription( "sysdiagrams", "sysdiagramCollectionView", TablesGroup, GetPeekCollectionViewModelFactory(x => x.sysdiagrams)),
			};
        }
