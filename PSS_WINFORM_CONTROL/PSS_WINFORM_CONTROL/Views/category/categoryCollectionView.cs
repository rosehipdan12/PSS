...
namespace PSS_WINFORM_CONTROL.Views.categoryCollectionView{
    public partial class categoryCollectionView : XtraUserControl {
        ...
        void InitBindings() {
            ...
            var fluentAPI = mvvmContext.OfType<PSS_WINFORM_CONTROL.ViewModels.categoryCollectionViewModel>();
