namespace PSS_WINFORM_CONTROL.Views.categoryView {
    partial class categoryView {
		...
		private void InitializeComponent() {
			...
			this.categoryViewBindingSource.DataSource = typeof(PSS_WINFORM_CONTROL.category);
		    ...
		    this.category1GridView.PopulateColumns(typeof(PSS_WINFORM_CONTROL.category),category1PopulateColumnsParameters);
			//
			...
			category1BindingSource.DataSource = typeof(PSS_WINFORM_CONTROL.category);
		    ...
		    this.itemsGridView.PopulateColumns(typeof(PSS_WINFORM_CONTROL.item),itemsPopulateColumnsParameters);
			//
			//itemsBindingSource
			//
			System.Windows.Forms.BindingSource itemsBindingSource = new System.Windows.Forms.BindingSource(this.components);
			itemsBindingSource.DataSource = typeof(PSS_WINFORM_CONTROL.item);
			...
			//category2LookUpEdit
			//
			this.category2BindingSource.DataSource = typeof(PSS_WINFORM_CONTROL.category);
            ...
            this.mvvmContext.ViewModelType = typeof(PSS_WINFORM_CONTROL.ViewModels.categoryViewModel);
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(PSS_WINFORM_CONTROL.ViewModels.categoryViewModel), "Save", bbiSave));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(PSS_WINFORM_CONTROL.ViewModels.categoryViewModel), "SaveAndClose", bbiSaveAndClose));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(PSS_WINFORM_CONTROL.ViewModels.categoryViewModel), "SaveAndNew", bbiSaveAndNew));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(PSS_WINFORM_CONTROL.ViewModels.categoryViewModel), "Reset", bbiReset));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(PSS_WINFORM_CONTROL.ViewModels.categoryViewModel), "Delete", bbiDelete));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(PSS_WINFORM_CONTROL.ViewModels.categoryViewModel), "Close", bbiClose));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(PSS_WINFORM_CONTROL.ViewModels.categoryViewModel), "SaveLayout", bbiSaveLayout));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(PSS_WINFORM_CONTROL.ViewModels.categoryViewModel), "ResetLayout", bbiResetLayout));
