...
namespace PSS_WINFORM_CONTROL.Views.order_productCollectionView{
    public partial class order_productCollectionView : XtraUserControl {
        public order_productCollectionView() {
            InitializeComponent();
        ...
        void InitBindings() {
            ...
            var fluentAPI = mvvmContext.OfType<PSS_WINFORM_CONTROL.ViewModels.order_productCollectionViewModel>();
