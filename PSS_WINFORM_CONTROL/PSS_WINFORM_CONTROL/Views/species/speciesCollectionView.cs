...
namespace PSS_WINFORM_CONTROL.Views.speciesCollectionView{
    public partial class speciesCollectionView : XtraUserControl {
        public speciesCollectionView() {
            InitializeComponent();
        ...
        void InitBindings() {
            ...
            var fluentAPI = mvvmContext.OfType<PSS_WINFORM_CONTROL.ViewModels.speciesCollectionViewModel>();
            ...
            fluentAPI.WithEvent<GridView, FocusedRowObjectChangedEventArgs>(gridView, "FocusedRowObjectChanged")
                .SetBinding(x => x.SelectedEntity,
                    args => args.Row as PSS_WINFORM_CONTROL.species,
