namespace PSS_WINFORM_CONTROL.Views.speciesCollectionView {
    partial class speciesCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.ribbonPageGroup1.Text = "species Tasks";
			...
			this.speciesCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.speciesCollectionViewBindingSource.DataSource = typeof(PSS_WINFORM_CONTROL.species);
			this.gridControl.DataSource = speciesCollectionViewBindingSource;
			...
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters petsPopulateColumnParameters_NotVisible = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            petsPopulateColumnParameters_NotVisible.FieldName = "pets";
		    petsPopulateColumnParameters_NotVisible.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(petsPopulateColumnParameters_NotVisible);
			 
			this.gridView.PopulateColumns(typeof(PSS_WINFORM_CONTROL.species),parameters);
			// 
            // popupMenu1
            // 
            ...
            this.mvvmContext.ViewModelType = typeof(PSS_WINFORM_CONTROL.ViewModels.speciesCollectionViewModel);
								this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(PSS_WINFORM_CONTROL.ViewModels.speciesCollectionViewModel), "New", bbiNew));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(PSS_WINFORM_CONTROL.ViewModels.speciesCollectionViewModel), "Edit", "SelectedEntity", bbiEdit));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(PSS_WINFORM_CONTROL.ViewModels.speciesCollectionViewModel), "Delete", "SelectedEntity", bbiDelete));
					this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(PSS_WINFORM_CONTROL.ViewModels.speciesCollectionViewModel), "Refresh", bbiRefresh));
            ...
            this.Name = "speciesCollectionView";
		...
		private System.Windows.Forms.BindingSource speciesCollectionViewBindingSource;
