namespace PSS_WINFORM_CONTROL.Views.roleCollectionView {
    partial class roleCollectionView {
		...
		private void InitializeComponent() {
			...
			this.roleCollectionViewBindingSource.DataSource = typeof(PSS_WINFORM_CONTROL.role);
			this.gridControl.DataSource = roleCollectionViewBindingSource;
			...
			this.gridView.PopulateColumns(typeof(PSS_WINFORM_CONTROL.role),parameters);
			// 
            // popupMenu1
            // 
            ...
            this.mvvmContext.ViewModelType = typeof(PSS_WINFORM_CONTROL.ViewModels.roleCollectionViewModel);
								this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(PSS_WINFORM_CONTROL.ViewModels.roleCollectionViewModel), "New", bbiNew));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(PSS_WINFORM_CONTROL.ViewModels.roleCollectionViewModel), "Edit", "SelectedEntity", bbiEdit));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(PSS_WINFORM_CONTROL.ViewModels.roleCollectionViewModel), "Delete", "SelectedEntity", bbiDelete));
					this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(PSS_WINFORM_CONTROL.ViewModels.roleCollectionViewModel), "Refresh", bbiRefresh));
