...
namespace PSS_WINFORM_CONTROL.Views.orderCollectionView{
    public partial class orderCollectionView : XtraUserControl {
        ...
        void InitBindings() {
            ...
            var fluentAPI = mvvmContext.OfType<PSS_WINFORM_CONTROL.ViewModels.orderCollectionViewModel>();
            ...
            fluentAPI.WithEvent<GridView, FocusedRowObjectChangedEventArgs>(gridView, "FocusedRowObjectChanged")
                .SetBinding(x => x.SelectedEntity,
                    args => args.Row as PSS_WINFORM_CONTROL.order,
