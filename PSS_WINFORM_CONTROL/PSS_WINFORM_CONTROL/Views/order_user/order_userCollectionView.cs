...
namespace PSS_WINFORM_CONTROL.Views.order_userCollectionView{
    public partial class order_userCollectionView : XtraUserControl {
        public order_userCollectionView() {
            InitializeComponent();
        ...
        void InitBindings() {
            ...
            var fluentAPI = mvvmContext.OfType<PSS_WINFORM_CONTROL.ViewModels.order_userCollectionViewModel>();
