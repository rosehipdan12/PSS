namespace PSS_WINFORM_CONTROL.Views.sysdiagramCollectionView {
    partial class sysdiagramCollectionView {
		...
		private void InitializeComponent() {
			...
			this.gridView.PopulateColumns(typeof(PSS_WINFORM_CONTROL.sysdiagram),parameters);
			// 
            // popupMenu1
            // 
            ...
            this.mvvmContext.ViewModelType = typeof(PSS_WINFORM_CONTROL.ViewModels.sysdiagramCollectionViewModel);
								this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(PSS_WINFORM_CONTROL.ViewModels.sysdiagramCollectionViewModel), "New", bbiNew));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(PSS_WINFORM_CONTROL.ViewModels.sysdiagramCollectionViewModel), "Edit", "SelectedEntity", bbiEdit));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(PSS_WINFORM_CONTROL.ViewModels.sysdiagramCollectionViewModel), "Delete", "SelectedEntity", bbiDelete));
					this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(PSS_WINFORM_CONTROL.ViewModels.sysdiagramCollectionViewModel), "Refresh", bbiRefresh));
