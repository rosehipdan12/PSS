namespace PSS_WINFORM_CONTROL.Views.supplierCollectionView {
    partial class supplierCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.ribbonPageGroup1.Text = "supplier Tasks";
			...
			this.supplierCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.supplierCollectionViewBindingSource.DataSource = typeof(PSS_WINFORM_CONTROL.supplier);
			this.gridControl.DataSource = supplierCollectionViewBindingSource;
			...
			this.gridView.PopulateColumns(typeof(PSS_WINFORM_CONTROL.supplier),parameters);
			// 
            // popupMenu1
            // 
            ...
            this.mvvmContext.ViewModelType = typeof(PSS_WINFORM_CONTROL.ViewModels.supplierCollectionViewModel);
								this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(PSS_WINFORM_CONTROL.ViewModels.supplierCollectionViewModel), "New", bbiNew));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(PSS_WINFORM_CONTROL.ViewModels.supplierCollectionViewModel), "Edit", "SelectedEntity", bbiEdit));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(PSS_WINFORM_CONTROL.ViewModels.supplierCollectionViewModel), "Delete", "SelectedEntity", bbiDelete));
					this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(PSS_WINFORM_CONTROL.ViewModels.supplierCollectionViewModel), "Refresh", bbiRefresh));
            ...
            this.Name = "supplierCollectionView";
		...
		private System.Windows.Forms.BindingSource supplierCollectionViewBindingSource;
