namespace PSS.Views.petView {
    partial class petView {
		...
		private void InitializeComponent() {
			...
			this.petViewBindingSource.DataSource = typeof(PSS.pet);
			this.dataLayoutControl1.DataSource = petViewBindingSource;
			//
			//Create GridControls
			//
			...
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters speciesorder_productChildPopulateColumnParameters = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            speciesorder_productChildPopulateColumnParameters.FieldName = "speciesorder_product";
            speciesorder_productChildPopulateColumnParameters.Path = "species.name";
			order_productPopulateColumnsParameters.CustomColumnParameters.Add(speciesorder_productChildPopulateColumnParameters);
			...
			//speciesLookUpEdit
			//
			this.speciesBindingSource.DataSource = typeof(PSS.species);
			...
			this.speciesLookUpEdit.DataBindings.Add("EditValue", petViewBindingSource, "species_id", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
			DevExpress.XtraDataLayout.RetrieveFieldParameters speciesLookUpEditRetrieveFieldParameters = new DevExpress.XtraDataLayout.RetrieveFieldParameters();
            speciesLookUpEditRetrieveFieldParameters.FieldName = "species_id";
            speciesLookUpEditRetrieveFieldParameters.ControlForField = this.speciesLookUpEdit;
			parameters.CustomListParameters.Add(speciesLookUpEditRetrieveFieldParameters);
			DevExpress.XtraDataLayout.RetrieveFieldParameters speciesLookUpEditRetrieveFieldParameters_NotGenerate = new DevExpress.XtraDataLayout.RetrieveFieldParameters();
		    speciesLookUpEditRetrieveFieldParameters_NotGenerate.FieldName = "species";
		    speciesLookUpEditRetrieveFieldParameters_NotGenerate.GenerateField = false;
			parameters.CustomListParameters.Add(speciesLookUpEditRetrieveFieldParameters_NotGenerate);
            ...
            this.mvvmContext.ViewModelType = typeof(PSS.ViewModels.petViewModel);
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(PSS.ViewModels.petViewModel), "Save", bbiSave));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(PSS.ViewModels.petViewModel), "SaveAndClose", bbiSaveAndClose));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(PSS.ViewModels.petViewModel), "SaveAndNew", bbiSaveAndNew));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(PSS.ViewModels.petViewModel), "Reset", bbiReset));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(PSS.ViewModels.petViewModel), "Delete", bbiDelete));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(PSS.ViewModels.petViewModel), "Close", bbiClose));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(PSS.ViewModels.petViewModel), "SaveLayout", bbiSaveLayout));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(PSS.ViewModels.petViewModel), "ResetLayout", bbiResetLayout));
